...
function ChangePinScreen({ navigation }) {
  ...
  function ListTransactionScreen({ navigation }) {
    return ( 
      <SafeAreaView style={styles.container}>
      <Text style={styles.bankname}>
              BCU BANKING APP
...
const HomeScreen = () => (
  <Drawer.Navigator initialRouteName="DashboardScreens2" >
        ...
        <Drawer.Screen name="Accounts" component={ListAccountScreen}   />
        <Drawer.Screen name="Transfer" component={TransferScreen}  />
        <Drawer.Screen name="Transaction" component={ListTransactionScreen}   />
        <Drawer.Screen name="Open Account" component={AccountOpeningScreen}  />
        <Drawer.Screen name="Change Pin" component={ChangePinScreen}  />
